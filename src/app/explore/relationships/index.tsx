...
export default function RelationshipsSectionHome() {
  return (
    <SafeAreaView
      className="flex-1 bg-suhrhit-surface"
      edges={["top", "bottom"]}
    >
      ...
      <ScrollView className="flex-1 px-6" showsVerticalScrollIndicator={false}>
        ...
        <View className="mb-8 mt-2">
          <View className="w-16 h-16 rounded-full bg-suhrhit-background items-center justify-center mb-4 overflow-hidden border border-[#D3C7F3]">
            <Image
              source={require("../../../assets/images/social_support_icon.png")}
              style={{ width: 44, height: 44, resizeMode: "contain" }}
            />
          </View>
          <Text
            className="text-suhrhit-primary text-[28px] leading-[34px] font-bold mb-3"
            style={{ fontFamily: "Georgia" }}
          >
            Relationship &{"\n"}Social Life
          </Text>
          <Text className="text-suhrhit-primary/70 text-[15px] leading-[22px]">
            Build stronger connections, feel supported, and take care of your
        ...
        >
          <View className="flex-1 mr-4">
            <View className="flex-row items-center gap-4">
              ...
              <Text className="text-suhrhit-primary font-bold text-[16px]">
        ...
        <Text className="text-suhrhit-primary font-bold text-[18px] mb-5">
          Explore more
        </Text>
  ...
  return (
    ...
    >
      ...
      <View className="flex-1 mr-2">
        ...
        <Text className="text-suhrhit-primary/70 text-[13px] leading-[18px]">
          {subtitle}
        </Text>
      </View>
      <ChevronRight color="#A6B9C7" size={20} />
